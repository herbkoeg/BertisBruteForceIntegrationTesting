...
public class TestCaseProcessor implements ITestCaseProcessor {
    ...
    TestCase generateTestCase(List<String> sqlListReferenceAction) throws SQLException, IllegalArgumentException {
    ...
    protected List<String> processCommand(String sql, List<String> ignoredColumns, Map<String, String> variables) throws SQLException {
