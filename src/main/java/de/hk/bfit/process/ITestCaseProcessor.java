...
interface ITestCaseProcessor {
    ...
    void assertBefore(TestCase testCase, Map<String, String> variables, Map<String, String> replacements) throws SQLException;
    ...
    void assertAfter(TestCase testCase, Map<String, String> variables, Map<String, String> replacements) throws SQLException;
