...
public class TestCaseProcessorTest {
    ...
    public void testGetDifferencesNoDifferences() {
        ...
        System.out.println(cut.determineDifferences(selectCmd, null,null, actualResults).toString());
        Assert.assertEquals(0, cut.determineDifferences(selectCmd, null,null, actualResults).size());
    }
    ...
    public void testGetDifferencesWithOneDifference() {
        ...
        System.out.println(cut.determineDifferences(selectCmd, null,null, actualResults).toString());
        Assert.assertEquals(1, cut.determineDifferences(selectCmd, null, null, actualResults).size());
    }
